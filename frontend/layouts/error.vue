    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <h1 v-if="error.statusCode === 404" class="error-404-title font-weight--light text-white">
            Oops! Page not found!
          </h1>
          <h1 v-else class="error-404-title font-weight--light text-white">
            An error occurred
          </h1>
          <div class="error-buttons section-space--mt_30">
            <n-link class="bk-btn theme-btn" to="/">
